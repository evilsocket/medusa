    ...
    fn configure_tls(config: &Config) -> Result<Option<TlsAcceptor>, Error> {
        ...
        if config.tls {
            ...
            config
                ...
                .map_err(|e| format!("could not set https certificate and key: {}", e))?;
